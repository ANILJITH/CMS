...
if(isset($_POST['pay']))
 {
 		addcredit($id,$amount);
 		header('location:/canteen/student/shome.php');
 }
	...
	<div class="mainw3-agile">
		...
		<div class="main-agileinfo">
			<div class="w3pay-left">
				...
				<h6><a href="/canteen/student/preorder.php"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Cancel your payment</a></h6>
			</div>
