            ...
            <div class="container">
                ...
                <div class="row-fluid">    
                    ...
                    <div class="span4">
                        ...
                        <div class="span5">
                            <div class="higlighted-box center">
                            <button class="button button-sp" style="color:#181A1C ; background-color: #fece1a;">Delete Order</button>
                            </div>
                        </div>
                    </div>
                 </div>
                 <div class="span6">
                        <div class="higlighted-box center">
                            <button class="button" style="color:#181A1C ; background-color: #fece1a;padding-top: 15px;">Bill</button>
                            </div>
                 </div> 
